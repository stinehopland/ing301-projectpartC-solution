...
def build_demo_house() -> SmartHouse:
    ...
    living = Room(rid=1, area=39.75, name="Living Room / Kitchen",devices=[])
    entre = Room(rid=2, area=13.5, name="Entrance", devices=[])
    guest1 = Room(rid=3, area=8, name="Guest Room 1", devices=[])
    bath1 = Room(rid=4, area=6.3, name="Bathroom 1", devices=[])
    garage = Room(rid=5, area=19, name="Garage", devices=[])

    floor1 = Floor(fid=1, level=1, rooms=[living, entre, guest1, bath1, garage])

    # floor 2 and rooms

    office = Room(rid=6, area=11.75, name="Office", devices=[])
    bath2 = Room(rid=7, area=9.25, name="Bathroom 2", devices=[])
    guest2 = Room(rid=8, area=8, name="Guest Room 2", devices=[])
    hall = Room(rid=9, area=10, name="Gang", devices=[])
    guest3 = Room(rid=10, area=10, name="Guest Room 3", devices=[])
    dress = Room(rid=11, area=4, name="Dressing Room", devices=[])
    bed = Room(rid=12, area=17, name="Master Bedroom", devices=[])
